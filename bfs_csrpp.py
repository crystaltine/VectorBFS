...
from csrpp.csrpp3 import BitArrayGraph, TorchGraph3, TorchGraph4
...
print(f"Created \x1b[33mAlternative Graph\x1b[0m ({1000*(perf_counter() - start_time):.1f}ms)")
...
use_testset = input("Use testset 1? (y/anything else): ")
...
print(f"Average speedup: \x1b[35mx{(total_speedup_multiplier / TESTSET_LEN):.2f} factor\x1b[0m / \x1b[33mx{(total_time_python / total_time_alt):.2f} timesave\x1b[0m")