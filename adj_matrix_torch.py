...
class TorchAdjacencyMatrixGraph():
    ...
    def __init__(self, is_directed:bool) -> None:
        self.adjacency_matrix: torch.Tensor = torch.empty(0, 0)
    ...
    def add_node(self, name:str) -> None:
        ...
        for row in self.adjacency_matrix: row.add(None)
        self.adjacency_matrix.add([None] * (len(self.adjacency_matrix) + 1))
    ...
    def remove_node(self, name:any) -> None:
        ...
        for row in self.adjacency_matrix:
            ...
            row[:-1] # Delete last column since it has been shifted forward
        ...
        self.adjacency_matrix = self.adjacency_matrix[:-1] # Delete last row since it has been shifted forward
